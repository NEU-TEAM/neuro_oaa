...
################################################################################################
## Launch all functions of neurobot except base
...
## Launch neurobot launch files except base
gnome-terminal -t "neurobot" -x bash -c "expect ${BASE_PATH}/launch_no_base.tcl $ROBOT_IP $PASSWORD;exec bash;"
